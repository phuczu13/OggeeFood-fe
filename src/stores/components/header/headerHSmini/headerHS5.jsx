                ...
                <div className="flex flex-col sm:flex-row justify-between items-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-12 items-center">
                        <div className='flex flex-col sm:flex-row gap-4 sm:gap-8'>
                            <Link to='/home-store' state={{ storeId }} className='hover:text-[#ef4c2b] font-semibold'>
                                Món ăn
                            </Link>
                            ...
                            <Link className='text-[#ef4c2b] font-semibold border-b-2 border-[#ef4c2b] rounded-sm' to='/infor-store' state={{ storeId }}>
                                Thông tin cửa hàng
                            </Link>
                        </div>
