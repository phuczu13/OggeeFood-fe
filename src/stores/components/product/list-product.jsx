...
function ListProduct() {
    ...
    const handleSave = () => {
        ...
        if (isEditing) {
            ...
            toast.success('Cập nhật món thành công!', { duration: 2000 }); // Toast for edit success
        } else {
            setProducts([ ...products, { ...currentProduct, id: products.length + 1 }]);
            toast.success('Thêm món thành công!', { duration: 2000 }); // Toast for add success
        }
    ...
    const handleDelete = () => {
        ...
        toast.success('Xóa món thành công!', { duration: 2000 }); // Toast for delete success
