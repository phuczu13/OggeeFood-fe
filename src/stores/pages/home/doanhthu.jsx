...
function DoanhThu() {
    // const data = [
    //     { orderId: '#12345', total: '500,000', value: '450,000', revenue: '400,000' },
    //     { orderId: '#12346', total: '600,000', value: '550,000', revenue: '500,000' },
    //     { orderId: '#12347', total: '300,000', value: '270,000', revenue: '250,000' },
    //   ];
    ...
    const totalRevenue = data.reduce((sum, item) => sum + item.storeRevenue, 0);
