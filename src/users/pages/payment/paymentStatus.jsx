    ...
    return (
        <div className="payment-status">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center py-10 max-w-[500px] w-full">
                ...
                <div className="rounded-full flex mx-auto border-green-500 w-fit">
                <img className='w-[250px] h-[250px]' src="https://th.bing.com/th/id/R.a1c1a8331f107deedf8ef54de1b257e3?rik=oqQ50DLg6fye8A&riu=http%3a%2f%2fcraftizen.org%2fwp-content%2fuploads%2f2019%2f02%2fsuccessful_payment_388054.png&ehk=Em4ImyRV5nk%2bEJIoj56uumAei6qyyq8J7UZVyyjeqIM%3d&risl=&pid=ImgRaw&r=0" alt="iCon" />
                </div>
