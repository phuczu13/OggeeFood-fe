    ...
    return (
        <>
            <div className="px-4 sm:px-[150px] py-[15px] border-b bg-white">
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden sm:flex gap-12 items-center">
                        <div className='flex flex-col sm:flex-row gap-4 sm:gap-8'>
                            <Link className='text-[#ef4c2b] font-semibold border-b-2 border-[#ef4c2b] rounded-sm' to='/home-page'>
                                Món ăn
                            </Link>
                        ...
                        <ul className="flex gap-4">
                            <li>
                                <Link 
                                    ...
                                    onClick={() => {
                                        setIsMenuOpen(false); // Ẩn menu khi nhấn
                                    }}
                                >
                                    Món ăn
                                </Link>
                ...
                <div className="absolute bg-white border rounded-lg shadow-lg p-4 mt-2 w-full sm:w-[250px]">
